...
<?php include 'courses_header.php'; ?>  
     ...
     <div class="img-text container" >
        ...
        <h1 class="text-center">Graphics Design</h1>
          <p class="text-center">Learn more about Graphic Design  </p>
                ...
                <img src="../images/g_d.jpg" alt="" class="course-img">
                  ...
                  <div class="col-lg-7 col-sm-12 col-md-12">
                    ...
                    <div class="border mb-2 "></div>
                        ...
                        letter-spacing: 1px;">
                          Graphic design is the process of visual communication and problem-solving through the use of typography, photography, and illustration. As the field is considered a subset of visual communication and communication design so It's job field is huge. So we offer best training to you for your better career
                        </p>
