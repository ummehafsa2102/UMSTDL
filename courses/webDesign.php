...
<?php include 'courses_header.php'; ?>  
     ...
     <div class="img-text container" >
        ...
        <h1 class="text-center">Web Design and Development</h1>
          <p class="text-center">Learn more about Web Design and Development  </p>
                ...
                <img src="../images/g_d.jpg" alt="" class="course-img">
                  ...
                  <div class="col-lg-7 col-sm-12 col-md-12">
                    ...
                    <div class="border mb-2 "></div>
                        ...
                        letter-spacing: 1px;">
                       Web site is considered as Second office of any company. So job sector in web development is bright. Our institution offers best possible training in low cost on web development. Our professional trainers guide you to develop yourself in both frontend and backend  by learning Html, css, laravel, php, javascript, jquery.
                        </p>
