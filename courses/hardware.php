...
<?php include 'courses_header.php'; ?>  
     ...
     <div class="img-text container" >
        ...
        <h1 class="text-center">Computer Hardware</h1>
          <p class="text-center">Learn more about Computer Hardware </p>
      ...
      <div class="information p-5 m-5 ">
        <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-lg-5 col-sm-12 col-md-12-5" >
            
                <img src="../images/c_h.jpg" alt="" class="course-img">
                  ...
                  <div class="col-lg-7 col-sm-12 col-md-12">
                    ...
                    <div class="border mb-2 "></div>
                        ...
                        letter-spacing: 1px;">
                          Learning autocade with us will make you create fully functioning product in a matter of short course. We provide best training on autocade within low cost.
                        </p>
